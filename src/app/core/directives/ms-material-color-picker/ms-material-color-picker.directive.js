(function ()
{
    ...
    /** @ngInject */
    function msMaterialColorPicker($mdMenu, $mdColorPalette, aapGenerator)
    {
        return {
            require    : 'ngModel',
            restrict   : 'E',
            ...
            link       : function ($scope, element, attrs, ngModel)
            {
                ...
                function updateSelectedColor(palette, hue)
                {
                    $scope.selectedColor = {
                        ...
                        bgColorValue: aapGenerator.rgba($scope.palettes[palette][hue].value),
                        fgColorValue: aapGenerator.rgba($scope.palettes[palette][hue].contrast)
                    };
